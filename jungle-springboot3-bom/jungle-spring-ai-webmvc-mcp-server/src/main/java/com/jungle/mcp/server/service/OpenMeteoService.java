...
public class OpenMeteoService {
     ...
     * @return 经纬度
     */
    @Tool(description = "获取一个地点的经纬度信息")
    public String getLonLatByLocation(@ToolParam(description = "地点名称") String location) {
        log.info(">>>>>> 获取{}的经纬度信息", location);
        Map<String, String> localToLonLatMap = Map.of(
                "成都", "104.0667, 30.6667",
                "北京", "116.4074, 39.9042");
        return localToLonLatMap.getOrDefault(location, "此地点的经纬度信息查询失败");
    }
    ...
    public String getWeatherForecastByLocation(@ToolParam(description = "经度") double longitude,
                                               @ToolParam(description = "纬度") double latitude) {
        log.info(">>>>>> 获取指定经纬度的天气预报{} {}", longitude, latitude);
